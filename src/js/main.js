...
const upg1 = {amount:0, cost:10, multi:2};
const upg2 = {amount:0, cost:100, multi:4};
const upg3 = {amount:0, cost:1000, multi:6};
const upg4 = {amount:0, cost:10000, multi:8};
const upg5 = {amount:0, cost:100000, multi:10};
...
// an interval that checks if you have enough points to buy any of the upgrades
function buttontic() {
...
// an interval that check how many of each upgrade you have and adds
// the total points per second
function gametic() {
...
// when you try to buy an upgrade this checks if you have enough points,
// if you have enough points it will remove the amount that the upgrade costs
// and add +1 to how many you have of that upgrade
function upgrade1() {
